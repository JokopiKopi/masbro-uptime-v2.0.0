...
module.exports = {
  async execute(client) {
    let aio = `Welcome to ${'Server Handler'.bold.blue} by ${'Masbro Uptime'.red}`;
    let aio_server = `Support:- ${`https://discord.gg/cEDeDyactC`.brightGreen}`
    let Uo = `Coded By ${`Masbro Uptime`.brightCyan.bold}`;
    console.clear()
